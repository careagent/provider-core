 ...
 *
 * When a provider first activates CareAgent with `/careagent-on` and no
...
> Your CareAgent configuration has been saved. To activate clinical mode, send \`/careagent-on\`.
